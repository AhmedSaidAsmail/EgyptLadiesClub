            ...
            <div class="col-md-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title"><i class="fa fa-pencil"></i> Update Filter</h3>
                    </div>
                    <!-- /.box-header -->
                    <form method="post" id="create_filter" action="{{route('filter.update',['id'=>$filter->id])}}">
                        {{csrf_field()}}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="input-group">
                                        ...
                                        <input type="text" value="{{$filter->ar_name}}" name="ar_name" class="form-control" placeholder="Filter Group Name" required>
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon"><img src="{{asset('images/admin/flag-eng.png')}}"></span>
                                        <input type="text" value="{{$filter->en_name}}" name="en_name" class="form-control" placeholder="Filter Group Name" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="number" min="0" name="sort_order" value="{{$filter->sort_order}}" class="form-control">
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <table class="table-bordered-sp">
                                        ...
                                        <tbody>
                                            @foreach($filter->filter_items as $filter_items)
                                            <tr>
                                                <td>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><img src="{{asset('images/admin/egypt-flag.png')}}"></span>
                                                        <input type="hidden" name="filter_item_id[]" value="{{$filter_items->id}}">
                                                        <input type="text" value="{{$filter_items->filter_ar_name}}" name="filter_ar_name[]" class="form-control" placeholder="Filter Group Name" required>
                                                    </div>
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><img src="{{asset('images/admin/flag-eng.png')}}"></span>
                                                        <input type="text" value="{{$filter_items->filter_en_name}}" name="filter_en_name[]" class="form-control" placeholder="Filter Group Name" required>
                                                    </div>
                                                </td>
                                                <td>
                                                    <input type="number" min="0" name="filter_sort_order[]" value="{{$filter_items->filter_sort_order}}" class="form-control">
                                                </td>
